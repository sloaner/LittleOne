...
private fun lightColorPreview() {
    Column(Modifier.padding(32.dp)) {
        drawSwatch(name = "Primary", color = LightColorPalette.primary, onColor = LightColorPalette.onPrimary)
        drawSwatch(name = "Primary Variant", color = LightColorPalette.primaryVariant)
        drawSwatch(name = "Secondary", color = LightColorPalette.secondary, onColor = LightColorPalette.onSecondary)
        drawSwatch(name = "Secondary Variant", color = LightColorPalette.secondaryVariant)
        drawSwatch(name = "Background", color = LightColorPalette.background, onColor = LightColorPalette.onBackground)
        drawSwatch(name = "Surface", color = LightColorPalette.surface, onColor = LightColorPalette.onSurface)
        drawSwatch(name = "Error", color = LightColorPalette.error, onColor = LightColorPalette.onError)
    }
}
...
private fun darkColorPreview() {
    Column(Modifier.padding(32.dp)) {
        drawSwatch(name = "Primary", color = DarkColorPalette.primary, onColor = DarkColorPalette.onPrimary)
        drawSwatch(name = "Primary Variant", color = DarkColorPalette.primaryVariant)
        drawSwatch(name = "Secondary", color = DarkColorPalette.secondary, onColor = DarkColorPalette.onSecondary)
        drawSwatch(name = "Secondary Variant", color = DarkColorPalette.secondaryVariant)
        drawSwatch(name = "Background", color = DarkColorPalette.background, onColor = DarkColorPalette.onBackground)
        drawSwatch(name = "Surface", color = DarkColorPalette.surface, onColor = DarkColorPalette.onSurface)
        drawSwatch(name = "Error", color = DarkColorPalette.error, onColor = DarkColorPalette.onError)
    }
}
